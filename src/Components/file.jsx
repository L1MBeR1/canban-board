...
const File = ({ fileName, fileType }) => {
    const getImagePath = (fileType) => {
        switch (fileType) {
            ...
            case 'dll':
                return require('../images/files/dll.png');
            case 'doc':
                return require('../images/files/doc.png');
            case 'eps':
                return require('../images/files/eps.png');
            case 'exe':
